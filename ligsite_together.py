...
def run_complete_workflow(file_path, output_dir="./output", voxel_size=0.5, MIN_PSP=3, probe_radius = 1.4):
    ...
    # Generate residues txt file with tables
    ...
    chimera_script_atoms_surface = os.path.join(chimera_output_dir, "surface_atoms_pockets_visualization.cmd")
    
    # Generate chimera scripts of different types of visualizations
    ...
    """
    # Generate individual PDB files for each pocket
    pocket_files = []
